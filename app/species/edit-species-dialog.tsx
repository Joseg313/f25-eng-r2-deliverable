...
export default function EditSpeciesDialog({ species }: { species: Species }) {
  ...
  const onSubmit = async (input: FormData) => {
    ...
    //change the defaultvalues from the add species form to the values that the species already has
    //instead of inserting the value we are going to update the values where the id equals the species id
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-screen overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Edit an existing species here. Click &quot;Submit Edit&quot; below when you&apos;re done.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
